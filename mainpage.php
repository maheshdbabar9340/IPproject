...
<body>
  <div class="topnav" id="myTopnav">
    <a class="active" href="mainpage.php" style="font-family: 'Crete Round'; font-size:22px;">NEPTUNIA <i class="fab fa-youtube"></i></a>
    <a id="ababab" href="about.html">About</a>
    ...
    q=queryString.split("=");
    if(q[1]!=undefined){
    var key1=q[1].replace(".",",");
    var key=key1.replace(".",",");
        ...
        function heh()
{
  ...
  <div class="w3-container">
    <div class="module" >
    <header>
      <p style="margin-top: 0px;" class="w3-center w3-animate-bottom"><span id="size1">Welcome</span></p>
    </header>
  </div>
...
<div class="wrapper">
<div class="beeche_me">
  <a href="www.google.com"><i class="fab fa-facebook-f" style="font-size:30px"></i></a>
  <a href="www.google.com" style="margin-left: 15px;"><i class="fab fa-instagram" style="font-size:30px"></i></a>
  <a href="www.google.com" style="margin-left: 15px;margin-right: 0px;"><i class="fab fa-twitter" style="font-size:30px"></i></a>
</div>
</div>
</div>
</body>
